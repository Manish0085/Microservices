...
public class CardController {
    ...
    @Operation(
            summary = "Build Details REST API",
    ...
    @Operation(
            summary = "System Details REST API",
            description = "REST API to fetch system details based on a mobile number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            summary = "Contact Details REST API",
